...
extension SettingVC {
  ...
  func conerReduis() {
    ...
    updateEmail.layer.borderColor = UIColor(red: 208/255, green: 44/255, blue: 166/255, alpha: 100).cgColor
    ...
    updateMobile.layer.borderColor = UIColor(red: 208/255, green: 44/255, blue: 166/255, alpha: 100).cgColor
  }
  func shadow(){
...
extension EditePasswordVC {
  ...
  func conerReduis() {
    ...
    sendBtn.layer.borderColor = UIColor(red: 208/255, green: 44/255, blue: 166/255, alpha: 100).cgColor
  }
  func shadow(){
